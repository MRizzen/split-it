...
import com.example.splititapp.Member;
...
public class BillDetailsActivity extends AppCompatActivity {
    ...
    private TextView detailTitle, detailTotal;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                response -> {
                    try {
                        ...
                        detailTotal.setText("Remaining: ₱" + String.format("%.2f", totalRemaining));
    ...
    private void showPayDialog(Member member) {
        ...
        etAmount.setHint("Enter amount (e.g. 50)");
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Pay", (dialog, which) -> {
                    ...
                    double amountToPay = Double.parseDouble(input);
                    ...
                    if (amountToPay <= 0) {
                        ...
                        Toast.makeText(this, "Amount exceeds balance (₱" + remainingBalance + ")", Toast.LENGTH_LONG).show();
                    }
                    else {
    ...
    private void updatePaymentInDB(String memberId, String amount) {
        String url = "http://10.0.2.2/split_it/update_payment.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                response -> {
                    Toast.makeText(this, "Payment Updated", Toast.LENGTH_SHORT).show();
                    loadMembers();
                }, error -> Toast.makeText(this, "Fail", Toast.LENGTH_SHORT).show()) {
            @Override
